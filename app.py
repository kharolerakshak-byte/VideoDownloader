...
class UniversalDownloader:
    ...
    def download_content(self, url, custom_path=None):
        ...
        download_folder_name = f"{platform}_{timestamp}"
        download_folder = os.path.join(path, download_folder_name)
        ...
        try:
            if platform == 'youtube':
                ...
                result = self.download_twitter_content(url, download_folder)
            elif platform == 'facebook':
                result = self.download_facebook_content(url, download_folder)
            else:
                # Try generic download for other platforms
                result = self.download_generic_content(url, download_folder)
            
            result['folder_name'] = download_folder_name
            return result
...
if __name__ == '__main__':
    ...
    print("Supported platforms: YouTube, Instagram, Twitter/X, Facebook, and more!")
